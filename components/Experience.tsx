...
const experiences = [
  {
    ...
    work: "Worked mostly as Front End Engineer, Gained immense knowledge on working with large scale applications, (Fi Navigator) Was able to work on multiple Repos, (Libraries, CMS, API, etc) and had opportunity to fix several bugs and develop debugging skills.",
  },
];
